  ...
  return (
    <Container>
      ...
      <AboutTextContainer ref={aboutTextContainer}>
        <AboutText>
          <>
            {`I'`}m a full-stack software developer with {yearsOfExperience} years of experience
            and {yearsOld} years old, a passion for creating beautiful and
            functional interfaces. {`I'`}m currently working at GeBIT as full-stack developer and{" "}
            {`I'`}m looking for new opportunities to grow my skills and
            knowledge.
          </>
        </AboutText>
        <AboutText ref={aboutTextContainer}>
          Actually {`I'`}m specialist in Web Development and Mobile Development, but in the future I
          want to learn more about the neural networks, C and Java. {`I'`}m
